...
public class SnowflakeIDGenerator {
    ...
    // ==============================Fields===========================================
    /** 开始时间截 (2020-10-19) */
    private static final long TWEPOCH =  1603036800000L;
    /**
     * 机器id所占的位数
     */
    ...
    private static SnowflakeIDGenerator snowflakeId=null;

    public static synchronized SnowflakeIDGenerator getInstance(){
        if(snowflakeId==null){
            snowflakeId=new SnowflakeIDGenerator();
        }
        return snowflakeId;
    }
